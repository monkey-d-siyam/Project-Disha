...
class SymptomParser:
    def __init__(self):
        ...
        self.symptom_map = {
            ...
            "shortness_of_breath": ["shash nite koshto", "shash kosto", "shashkosto", "shortness of breath", "breathing issue", "nisash nite kosto", "kosto hocche shash nite", "breathing difficulty"],
            "fever": ["jor", "fever", "tapmatra", "high temperature", "temperature"],
            "headache": ["matha betha", "matha batha", "headache", "mathabatha", "head ache"],
